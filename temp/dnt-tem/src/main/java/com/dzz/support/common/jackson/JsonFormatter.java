package com.dzz.support.common.jackson;
    ...
    private static ObjectMapper getMapper(boolean serializeNull) {
        ...
        if (null == tl.get()) {
            ...
            if (!serializeNull) {
                ...
                mapper.enable(new org.codehaus.jackson.map.SerializationConfig.Feature[]{org.codehaus.jackson.map.SerializationConfig.Feature.SORT_PROPERTIES_ALPHABETICALLY});
            }
